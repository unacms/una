...
('bx_froala_option_toolbar_standard', "{'moreText': {'buttons': ['bold', 'italic', 'underline', 'clearFormatting'],'buttonsVisible': 4},'moreParagraph': {'buttons': ['alignLeft', 'alignCenter', 'alignRight', 'formatOL', 'formatUL', 'paragraphFormat', 'outdent', 'indent', 'quote']},'moreRich': {'buttons': ['insertLink', 'insertImage','emoticons', 'embedly'],'buttonsVisible': 2},'moreMisc': {'buttons': ['undo', 'redo', 'fullscreen', 'html'],'align': 'right','buttonsVisible': 2}}", @iCategId, '_bx_froala_option_toolbar_standard', 'digit', '', '', '', 22),
