...
('bx_glossary_cats', '1', 1, '_bx_glossary_cat_Animals_Pets', ''),
('bx_glossary_cats', '2', 2, '_bx_glossary_cat_Architecture', ''),
('bx_glossary_cats', '3', 3, '_bx_glossary_cat_Art', ''),
('bx_glossary_cats', '4', 4, '_bx_glossary_cat_Cars_Motorcycles', ''),
('bx_glossary_cats', '5', 5, '_bx_glossary_cat_Celebrities', ''),
('bx_glossary_cats', '6', 6, '_bx_glossary_cat_Design', ''),
('bx_glossary_cats', '7', 7, '_bx_glossary_cat_DIY_Crafts', ''),
('bx_glossary_cats', '8', 8, '_bx_glossary_cat_Education', ''),
('bx_glossary_cats', '9', 9, '_bx_glossary_cat_Film_Music_Books', ''),
('bx_glossary_cats', '10', 10, '_bx_glossary_cat_Food_Drink', ''),
('bx_glossary_cats', '11', 11, '_bx_glossary_cat_Gardening', ''),
('bx_glossary_cats', '12', 12, '_bx_glossary_cat_Geek', ''),
('bx_glossary_cats', '13', 13, '_bx_glossary_cat_Hair_Beauty', ''),
('bx_glossary_cats', '14', 14, '_bx_glossary_cat_Health_Fitness', ''),
('bx_glossary_cats', '15', 15, '_bx_glossary_cat_History', ''),
('bx_glossary_cats', '16', 16, '_bx_glossary_cat_Holidays_Events', ''),
('bx_glossary_cats', '17', 17, '_bx_glossary_cat_Home_Decor', ''),
('bx_glossary_cats', '18', 18, '_bx_glossary_cat_Humor', ''),
('bx_glossary_cats', '19', 19, '_bx_glossary_cat_Illustrations_Posters', ''),
('bx_glossary_cats', '20', 20, '_bx_glossary_cat_Kids_Parenting', ''),
('bx_glossary_cats', '21', 21, '_bx_glossary_cat_Mens_Fashion', ''),
('bx_glossary_cats', '22', 22, '_bx_glossary_cat_Outdoors', ''),
('bx_glossary_cats', '23', 23, '_bx_glossary_cat_Photography', ''),
('bx_glossary_cats', '24', 24, '_bx_glossary_cat_Products', ''),
('bx_glossary_cats', '25', 25, '_bx_glossary_cat_Quotes', ''),
('bx_glossary_cats', '26', 26, '_bx_glossary_cat_Science_Nature', ''),
('bx_glossary_cats', '27', 27, '_bx_glossary_cat_Sports', ''),
('bx_glossary_cats', '28', 28, '_bx_glossary_cat_Tattoos', ''),
('bx_glossary_cats', '29', 29, '_bx_glossary_cat_Technology', ''),
('bx_glossary_cats', '30', 30, '_bx_glossary_cat_Travel', ''),
('bx_glossary_cats', '31', 31, '_bx_glossary_cat_Weddings', ''),
('bx_glossary_cats', '32', 32, '_bx_glossary_cat_Womens_Fashion', '');
...
('bx_glossary', 'bx_glossary_reports', 'bx_glossary_reports_track', '1', 'page.php?i=view-glossary&id={object_id}', 'bx_glossary_terms', 'id', 'author', 'reports', '', '');
...
('bx_glossary', 'bx_glossary_favorites_track', '1', '1', '1', 'page.php?i=view-glossary&id={object_id}', 'bx_glossary_terms', 'id', 'author', 'favorites', '', '');
...
('bx_glossary', '1', '1', 'page.php?i=view-glossary&id={object_id}', 'bx_glossary_terms', 'id', 'author', 'featured', '', '');
...
(@iPageId, 'bx_glossary', '{url_studio}module.php?name=bx_glossary', '', 'bx_glossary@modules/boonex/glossary/|std-icon.svg', '_bx_glossary', '', 'a:4:{s:6:"module";s:6:"system";s:6:"method";s:11:"get_actions";s:6:"params";a:0:{}s:5:"class";s:18:"TemplStudioModules";}');
