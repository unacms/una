...
SET @iTotalFilesSize = (SELECT SUM(`size`) FROM `bx_messages_files`);
SET @iTotalFilesNum = (SELECT COUNT(*) FROM `bx_messages_files`);
...
('bx_messages_preview', 'bx_messages_photos_resized', 'Storage', 'a:1:{s:6:"object";s:17:"bx_messages_files";}', 'no', '1', '2592000', '0');
