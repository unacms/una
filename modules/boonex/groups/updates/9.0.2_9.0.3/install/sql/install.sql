...
UPDATE `sys_objects_storage` SET `engine`=@sStorageEngine WHERE `object`='bx_groups_pics';
UPDATE `sys_objects_storage` SET `engine`=@sStorageEngine WHERE `object`='bx_groups_pics_resized';
