...
DELETE FROM `sys_menu_items` WHERE `set_name`='' AND `name` IN ('social-sharing', 'approve-group-profile', 'social-sharing-facebook', 'social-sharing-twitter', 'social-sharing-pinterest');
