...
BxAdsPolls.prototype.initFlickity = function(oParent) {
    if(!oParent)
        return;
...
BxAdsPolls.prototype.initPollForm = function(sFormId)
{
    var $this = this;
    var oForm = $('#' + sFormId);
...
BxAdsPolls.prototype.beforePollFormSubmit = function(oForm)
{
    this.loadingInButton($(oForm).children().find(':submit'), true);
};

BxAdsPolls.prototype.afterPollFormSubmit = function (oForm, oData)
{
    var $this = this;
...
BxAdsPolls.prototype.deletePoll = function(oLink, iId)
{
    var $this = this;
...
BxAdsPolls.prototype.showPollForm = function(oLink)
{
    var oData = this._getDefaultData();    
...
BxAdsPolls.prototype.changePollView = function(oLink, sView, iPollId, onComplete) {
    var $this = this;
...
BxAdsPolls.prototype.addPollAnswer = function(oButton, sName) {
    var oButton = $(oButton);
...
BxAdsPolls.prototype.deletePollAnswer = function(oButton) {
    $(oButton).parents('.bx-form-input-answer:first').remove();
};

BxAdsPolls.prototype.onPollAnswerVote = function(oLink, oData, iPollId) {
    var $this = this;
...
BxAdsPolls.prototype.loadingInButton = function(e, bShow) {
    if($(e).length)
...
BxAdsPolls.prototype.loadingInBox = function(e, bShow) {
    var oParent = $(e).length ? $(e).parents('.bx-base-text-poll:first') : $('body'); 
    bx_loading(oParent, bShow);
};

BxAdsPolls.prototype.loadingInBlock = function(e, bShow) {
    var oParent = $(e).length ? $(e).parents('.bx-db-container:first') : $('body'); 
    bx_loading(oParent, bShow);
};

BxAdsPolls.prototype._getDefaultData = function() {
    var oDate = new Date();
