...
('bx_events_time_format', '%H:%M', @iCategId, '_bx_events_option_time_format', 'digit', '', '', '', 20),
('bx_events_short_date_format', '%e %b %Y', @iCategId, '_bx_events_option_short_date_format', 'digit', '', '', '', 22),
('bx_events_datetime_format', '%e %b %Y %H:%M', @iCategId, '_bx_events_option_datetime_format', 'digit', '', '', '', 23),
...
('', 0, 'bx_events', '_bx_events_page_block_title_sys_cover_block', '_bx_events_page_block_title_cover_block', 3, 2147483647, 'service', 'a:2:{s:6:\"module\";s:9:\"bx_events\";s:6:\"method\";s:12:\"entity_cover\";}', 0, 1, 1, IFNULL(@iBlockOrder, 0) + 4);
...
('bx_events_view_actions', 'bx_events', 'profile-fan-add', '_bx_events_menu_item_title_system_become_fan', '{title_add_fan}', 'javascript:void(0)', 'bx_conn_action(this, \'bx_events_fans\', \'add\', \'{profile_id}\')', '', 'sign-in-alt', '', 0, 2147483647, 'a:3:{s:6:"module";s:9:"bx_events";s:6:"method";s:22:"is_free_join_avaliable";s:6:"params";a:1:{i:0;s:12:"{profile_id}";}}', 1, 0, 0, 5),
