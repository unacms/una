...
BxEventsPrices.prototype.checkName = function(sNameId, iId) {
    var oDate = new Date();
...
BxEventsPrices.prototype.onChangeRole = function() {
	this.reloadGrid($('#bx-grid-level-' + this._sObjNameGrid).val());
};

BxEventsPrices.prototype.reloadGrid = function(iRoleId) {
