...
UPDATE `sys_objects_storage` SET `engine`=@sStorageEngine WHERE `object`='bx_events_pics';
UPDATE `sys_objects_storage` SET `engine`=@sStorageEngine WHERE `object`='bx_events_pics_resized';
