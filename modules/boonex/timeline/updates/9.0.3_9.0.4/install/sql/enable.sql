...
UPDATE `sys_pages_blocks` SET `title_system`='_bx_timeline_page_block_title_system_view_account', `title`='_bx_timeline_page_block_title_view_account', `visible_for_levels`='2147483646', `active`='1', `order`=@iPBOrderDashboard + 1 WHERE `object`='bx_timeline_view_home' AND `title`='_bx_timeline_page_block_title_view';
UPDATE `sys_pages_blocks` SET `title_system`='_bx_timeline_page_block_title_system_view_account_outline', `title`='_bx_timeline_page_block_title_view_account_outline', `visible_for_levels`='2147483646', `active`='0', `order`=@iPBOrderDashboard + 1 WHERE `object`='bx_timeline_view_home' AND `title`='_bx_timeline_page_block_title_view_outline';

UPDATE `sys_pages_blocks` SET `title_system`='_bx_timeline_page_block_title_system_post_home', `title`='_bx_timeline_page_block_title_post_home', `active`='1' WHERE `object`='sys_home' AND `title`='_bx_timeline_page_block_title_post_home';
UPDATE `sys_pages_blocks` SET `title_system`='_bx_timeline_page_block_title_system_view_home', `title`='_bx_timeline_page_block_title_view_home', `active`='0' WHERE `object`='sys_home' AND `title`='_bx_timeline_page_block_title_view_home';
UPDATE `sys_pages_blocks` SET `title_system`='_bx_timeline_page_block_title_system_view_home_outline', `title`='_bx_timeline_page_block_title_view_home_outline', `active`='1' WHERE `object`='sys_home' AND `title`='_bx_timeline_page_block_title_view_home_outline';

UPDATE `sys_pages_blocks` SET `title_system`='_bx_timeline_page_block_title_system_post_profile', `title`='_bx_timeline_page_block_title_post_profile', `active`='1' WHERE `object`='trigger_page_profile_view_entry' AND `title`='_bx_timeline_page_block_title_post_profile';
UPDATE `sys_pages_blocks` SET `title_system`='_bx_timeline_page_block_title_system_view_profile', `title`='_bx_timeline_page_block_title_view_profile', `active`='1' WHERE `object`='trigger_page_profile_view_entry' AND `title`='_bx_timeline_page_block_title_view_profile';
UPDATE `sys_pages_blocks` SET `title_system`='_bx_timeline_page_block_title_system_view_profile_outline', `title`='_bx_timeline_page_block_title_view_profile_outline', `active`='0' WHERE `object`='trigger_page_profile_view_entry' AND `title`='_bx_timeline_page_block_title_view_profile_outline';
