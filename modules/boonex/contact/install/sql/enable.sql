...
('modules', @sName, '_bx_contact', 'bx_contact@modules/boonex/contact/|std-mi.png', IF(ISNULL(@iTypeOrder), 1, @iTypeOrder + 1));
...
(@sName, 'contact', NULL, '_bx_contact_acl_action_contact', '', 1, 1);
