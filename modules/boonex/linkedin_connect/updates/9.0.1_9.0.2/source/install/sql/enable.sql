...
('bx_linkedin_error', 'linkedin-error', '_bx_linkedin_error', '_bx_linkedin_error', 'bx_linkedin', 5, 2147483647, 0, '', '', '', '', 0, 1, 0, 'BxLinkedinPage', 'modules/boonex/linkedin_connect/classes/BxLinkedinPage.php');
