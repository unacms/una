...
('modules', 'bx_linkedin', '_bx_linkedin_adm_stg_cpt_type', 'bx_linkedin@modules/boonex/linkedin/|std-mi.png', IF(NOT ISNULL(@iTypeOrder), @iTypeOrder + 1, 1));
SET @iTypeId = LAST_INSERT_ID();

INSERT INTO `sys_options_categories` (`type_id`, `name`, `caption`, `order` )  
VALUES (@iTypeId, 'bx_linkedin_general', '_bx_linkedin_adm_stg_cpt_category_general', 1);
...
('bx_linkedin_redirect_page', 'dashboard', @iCategId, '_bx_linkedin_option_redirect', 'select', '', '', 40, 'join,settings,dashboard,index'),
('bx_linkedin_module', 'bx_persons', @iCategId, '_bx_linkedin_option_module', 'select', '', '', 50, 'a:2:{s:6:"module";s:11:"bx_linkedin";s:6:"method";s:20:"get_profiles_modules";}'),
('bx_linkedin_confirm_email', 'on', @iCategId, '_bx_linkedin_option_confirm_email', 'checkbox', '', '', 70, ''),
('bx_linkedin_approve', '', @iCategId, '_bx_linkedin_option_approve', 'checkbox', '', '', 80, '');
