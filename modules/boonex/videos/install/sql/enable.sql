...
('bx_videos_view_actions', 'bx_videos', 'set-badges', '_sys_menu_item_title_system_set_badges', '_sys_menu_item_title_set_badges', 'javascript:void(0)', 'bx_menu_popup(''sys_set_badges'', window, {}, {module: ''bx_videos'', content_id: {content_id}});', '', 'check-circle', '', '', 0, 2147483647, 'a:2:{s:6:"module";s:9:"bx_videos";s:6:"method";s:19:"is_badges_avaliable";}', 1, 0, 40),
...
('sys_profile_stats', 'bx_videos', 'profile-stats-my-videos', '_bx_videos_menu_item_title_system_manage_my_videos', '_bx_videos_menu_item_title_manage_my_videos', 'page.php?i=videos-author&profile_id={member_id}', '', '_self', 'film col-gray', 'a:2:{s:6:"module";s:9:"bx_videos";s:6:"method";s:41:"get_menu_addon_manage_tools_profile_stats";}', '', 2147483646, 1, 0, @iNotifMenuOrder + 1);
...
('bx_videos', 'bx_videos', 'bx_videos_meta_keywords', 'bx_videos_meta_locations', 'bx_videos_meta_mentions', '', '');
...
('bx_videos_cats', 'bx_videos', 'bx_videos', 'bx_videos', 'bx_videos_cats', 'bx_videos_entries', 'cat', 'INNER JOIN `sys_profiles` ON (`sys_profiles`.`id` = `bx_videos_entries`.`author`)', 'AND `sys_profiles`.`status` = ''active''', '', '');
