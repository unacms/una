...
('bx_videos_video_webm', 'bx_videos_media_resized', 'Storage', 'a:1:{s:6:"object";s:16:"bx_videos_videos";}', 'no', 0, 0, 0, 'BxDolTranscoderVideo', '');
...
('bx_videos_video_webm', 'Webm', 'a:2:{s:1:"h";s:3:"480";s:10:"force_type";s:4:"webm";}', 0);
...
('bx_videos', 'bx_videos', 'videos', 'a:1:{i:0;s:15:"bx_videos_html5";}', 'a:2:{s:16:"bx_videos_simple";s:26:"_sys_uploader_simple_title";s:15:"bx_videos_html5";s:25:"_sys_uploader_html5_title";}', 0, 'files', '_bx_videos_form_entry_input_sys_videos', '_bx_videos_form_entry_input_videos', '', 0, 0, 0, '', '', '', '', '', '', '', '', 1, 0),
...
('bx_videos_cats', '1', 1, '_bx_videos_cat_Animals_Pets', ''),
('bx_videos_cats', '2', 2, '_bx_videos_cat_Architecture', ''),
('bx_videos_cats', '3', 3, '_bx_videos_cat_Art', ''),
('bx_videos_cats', '4', 4, '_bx_videos_cat_Cars_Motorcycles', ''),
('bx_videos_cats', '5', 5, '_bx_videos_cat_Celebrities', ''),
('bx_videos_cats', '6', 6, '_bx_videos_cat_Design', ''),
('bx_videos_cats', '7', 7, '_bx_videos_cat_DIY_Crafts', ''),
('bx_videos_cats', '8', 8, '_bx_videos_cat_Education', ''),
('bx_videos_cats', '9', 9, '_bx_videos_cat_Film_Music_Books', ''),
('bx_videos_cats', '10', 10, '_bx_videos_cat_Food_Drink', ''),
('bx_videos_cats', '11', 11, '_bx_videos_cat_Gardening', ''),
('bx_videos_cats', '12', 12, '_bx_videos_cat_Geek', ''),
('bx_videos_cats', '13', 13, '_bx_videos_cat_Hair_Beauty', ''),
('bx_videos_cats', '14', 14, '_bx_videos_cat_Health_Fitness', ''),
('bx_videos_cats', '15', 15, '_bx_videos_cat_History', ''),
('bx_videos_cats', '16', 16, '_bx_videos_cat_Holidays_Events', ''),
('bx_videos_cats', '17', 17, '_bx_videos_cat_Home_Decor', ''),
('bx_videos_cats', '18', 18, '_bx_videos_cat_Humor', ''),
('bx_videos_cats', '19', 19, '_bx_videos_cat_Illustrations_Posters', ''),
('bx_videos_cats', '20', 20, '_bx_videos_cat_Kids_Parenting', ''),
('bx_videos_cats', '21', 21, '_bx_videos_cat_Mens_Fashion', ''),
('bx_videos_cats', '22', 22, '_bx_videos_cat_Outdoors', ''),
('bx_videos_cats', '23', 23, '_bx_videos_cat_Photography', ''),
('bx_videos_cats', '24', 24, '_bx_videos_cat_Products', ''),
('bx_videos_cats', '25', 25, '_bx_videos_cat_Quotes', ''),
('bx_videos_cats', '26', 26, '_bx_videos_cat_Science_Nature', ''),
('bx_videos_cats', '27', 27, '_bx_videos_cat_Sports', ''),
('bx_videos_cats', '28', 28, '_bx_videos_cat_Tattoos', ''),
('bx_videos_cats', '29', 29, '_bx_videos_cat_Technology', ''),
('bx_videos_cats', '30', 30, '_bx_videos_cat_Travel', ''),
('bx_videos_cats', '31', 31, '_bx_videos_cat_Weddings', ''),
('bx_videos_cats', '32', 32, '_bx_videos_cat_Womens_Fashion', '');
...
('bx_videos', 'bx_videos', 'bx_videos_cmts', 1, 5000, 1000, 1, 5, 3, 'tail', 1, 'bottom', 1, 1, 1, -3, 1, 'cmt', 'page.php?i=view-video&id={object_id}', '', 'bx_videos_entries', 'id', 'author', 'title', 'comments', '', '');
...
('bx_videos', 'bx_videos_reports', 'bx_videos_reports_track', '1', 'page.php?i=view-video&id={object_id}', 'bx_videos_entries', 'id', 'author', 'reports', '', '');
...
('bx_videos', 'bx_videos_favorites_track', '1', '1', '1', 'page.php?i=view-video&id={object_id}', 'bx_videos_entries', 'id', 'author', 'favorites', '', '');
...
(@iPageId, 'bx_videos', '{url_studio}module.php?name=bx_videos', '', 'bx_videos@modules/boonex/videos/|std-icon.svg', '_bx_videos', '', 'a:4:{s:6:"module";s:6:"system";s:6:"method";s:11:"get_actions";s:6:"params";a:0:{}s:5:"class";s:18:"TemplStudioModules";}');
