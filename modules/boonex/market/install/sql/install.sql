...
('bx_market_entry_add', 'header_beg_notes', 2147483647, 1, 23),
('bx_market_entry_add', 'notes', 2147483647, 1, 24),
('bx_market_entry_add', 'notes_purchased', 2147483647, 1, 25),
('bx_market_entry_add', 'header_end_notes', 2147483647, 1, 26),
('bx_market_entry_add', 'header_beg_other', 2147483647, 1, 27),
('bx_market_entry_add', 'location', 2147483647, 1, 28),
('bx_market_entry_add', 'subentries', 2147483647, 1, 29),
('bx_market_entry_add', 'header_end_other', 2147483647, 1, 30),
('bx_market_entry_add', 'do_publish', 2147483647, 1, 31),
...
('bx_market_entry_edit', 'header_beg_notes', 2147483647, 1, 23),
('bx_market_entry_edit', 'notes', 2147483647, 1, 24),
('bx_market_entry_edit', 'notes_purchased', 2147483647, 1, 25),
('bx_market_entry_edit', 'header_end_notes', 2147483647, 1, 26),
('bx_market_entry_edit', 'header_beg_other', 2147483647, 1, 27),
('bx_market_entry_edit', 'location', 2147483647, 1, 28),
('bx_market_entry_edit', 'subentries', 2147483647, 1, 29),
('bx_market_entry_edit', 'header_end_other', 2147483647, 1, 30),
('bx_market_entry_edit', 'do_submit', 2147483647, 1, 31),
...
('bx_market_notes', 'bx_market', 'bx_market_cmts_notes', 1, 5000, 1000, 3, 5, 3, 'tail', 1, 'bottom', 1, 1, 1, -3, 1, 'cmt', 'page.php?i=view-post&id={object_id}', '', 'bx_market_products', 'id', 'author', 'title', 'comments', '', '');
...
(@iPageId, 'bx_market', '{url_studio}module.php?name=bx_market', '', 'bx_market@modules/boonex/market/|std-icon.svg', '_bx_market', '', 'a:4:{s:6:"module";s:6:"system";s:6:"method";s:11:"get_actions";s:6:"params";a:0:{}s:5:"class";s:18:"TemplStudioModules";}');
