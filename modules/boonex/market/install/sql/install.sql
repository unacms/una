...
CREATE TABLE IF NOT EXISTS `bx_market_products` (
  ...
  `price_recurring` int(11) NOT NULL default '0',
...
('bx_market', 'bx_market', 'price_recurring', '', '#!bx_market_prices', 0, 'radio_set', '_bx_market_form_entry_input_sys_price_recurring', '_bx_market_form_entry_input_price_recurring', '_bx_market_form_entry_input_price_recurring_inf', 0, 0, 0, '', '', '', '', '', '', 'Float', '', 1, 0);
...
('bx_market_entry_add', 'price_single', 2147483647, 1, 8),
('bx_market_entry_add', 'price_recurring', 2147483647, 1, 9),
('bx_market_entry_add', 'allow_view_to', 2147483647, 1, 10),
('bx_market_entry_add', 'allow_purchase_to', 2147483647, 1, 11),
('bx_market_entry_add', 'allow_comment_to', 2147483647, 1, 12),
('bx_market_entry_add', 'allow_vote_to', 2147483647, 1, 13),
('bx_market_entry_add', 'location', 2147483647, 1, 14),
('bx_market_entry_add', 'do_submit', 2147483647, 0, 15),
('bx_market_entry_add', 'do_publish', 2147483647, 1, 16),
...
('bx_market_entry_edit', 'price_recurring', 2147483647, 1, 10),
('bx_market_entry_edit', 'allow_view_to', 2147483647, 1, 11),
('bx_market_entry_edit', 'allow_purchase_to', 2147483647, 1, 12),
('bx_market_entry_edit', 'allow_comment_to', 2147483647, 1, 13),
('bx_market_entry_edit', 'allow_vote_to', 2147483647, 1, 14),
('bx_market_entry_edit', 'location', 2147483647, 1, 15),
('bx_market_entry_edit', 'do_submit', 2147483647, 1, 16),
