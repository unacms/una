...
BxCoursesManageTools.prototype.onChangeFilter = function(oFilter) {
    var $this = this;
...
BxCoursesManageTools.prototype.onClickSettings = function(sMenuObject, oButton) {
...
BxCoursesManageTools.prototype.onClickDelete = function(iContentId) {
    $('.bx-popup-applied:visible').dolPopupHide();

    glGrids[this._sObjNameGrid].actionWithId(iContentId, 'delete', {}, '', false, 1);
};

BxCoursesManageTools.prototype.onClickDeleteWithContent = function(iContentId) {
    $('.bx-popup-applied:visible').dolPopupHide();
