...
DELETE FROM `sys_options` WHERE `name`='bx_courses_per_page_for_favorites_lists';
...
-- PAGES
DELETE FROM `sys_objects_page` WHERE `object`='bx_courses_join_profile';
...
DELETE FROM `sys_pages_blocks` WHERE `object`='bx_courses_join_profile';
...
DELETE FROM `sys_objects_page` WHERE `object`='bx_courses_profile_pricing';
INSERT INTO `sys_objects_page`(`object`, `uri`, `title_system`, `title`, `module`, `layout_id`, `visible_for_levels`, `visible_for_levels_editable`, `url`, `meta_description`, `meta_keywords`, `meta_robots`, `cache_lifetime`, `cache_editable`, `deletable`, `override_class_name`, `override_class_file`) VALUES 
...
DELETE FROM `sys_pages_blocks` WHERE `object`='bx_courses_profile_pricing';
...
DELETE FROM `sys_objects_page` WHERE `object`='bx_courses_favorites';
...
DELETE FROM `sys_pages_blocks` WHERE `object`='bx_courses_favorites';
INSERT INTO `sys_pages_blocks`(`object`, `cell_id`, `module`, `title_system`, `title`, `designbox_id`, `visible_for_levels`, `type`, `content`, `deletable`, `copyable`, `order`) VALUES 
...
-- MENUS
DELETE FROM `sys_menu_items` WHERE `set_name`='bx_courses_view_actions' AND `name`='join-course-profile';
...
DELETE FROM `sys_menu_items` WHERE `set_name`='bx_courses_view_actions_more' AND `name`='edit-course-pricing';
...
DELETE FROM `sys_menu_items` WHERE `set_name`='bx_courses_view_actions_all' AND `name` IN ('join-course-profile', 'edit-course-pricing');
...
DELETE FROM `sys_menu_items` WHERE `set_name`='bx_courses_snippet_meta' AND `name`='join-paid';
...
-- GRID
DELETE FROM `sys_grid_fields` WHERE `object`='bx_courses_fans' AND `name` IN ('role_added', 'role_expired');
...
UPDATE `sys_grid_fields` SET `width`='20%' WHERE `object`='bx_courses_fans' AND `name`='actions';

DELETE FROM `sys_objects_grid` WHERE `object` IN ('bx_courses_prices_manage', 'bx_courses_prices_view');
...
DELETE FROM `sys_grid_fields` WHERE `object` IN ('bx_courses_prices_manage', 'bx_courses_prices_view');
INSERT INTO `sys_grid_fields` (`object`, `name`, `title`, `width`, `translatable`, `chars_limit`, `params`, `order`) VALUES
('bx_courses_prices_manage', 'checkbox', '_sys_select', '1%', 0, 0, '', 1),
('bx_courses_prices_manage', 'order', '', '1%', 0, 0, '', 2),
...
('bx_courses_prices_manage', 'actions', '', '20%', 0, 0, '', 6),
...
('bx_courses_prices_view', 'actions', '', '20%', 0, 0, '', 4);

DELETE FROM `sys_grid_actions` WHERE `object` IN ('bx_courses_prices_manage', 'bx_courses_prices_view');
...
-- PRIVACY
DELETE FROM `sys_objects_privacy` WHERE `object`='bx_courses_allow_view_favorite_list';
...
-- CRON
DELETE FROM `sys_cron_jobs` WHERE `name`='bx_courses_pruning';
