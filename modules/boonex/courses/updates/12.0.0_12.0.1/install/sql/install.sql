-- TABLES
CREATE TABLE IF NOT EXISTS `bx_courses_favorites_lists` (
...
-- FORMS
DELETE FROM `sys_objects_form` WHERE `object`='bx_courses_price';
...
DELETE FROM `sys_form_displays` WHERE `object`='bx_courses_price';
...
DELETE FROM `sys_form_inputs` WHERE `object`='bx_courses_price';
...
('bx_courses_price', 'bx_courses', 'price', '', '', 0, 'text', '_bx_courses_form_price_input_sys_price', '_bx_courses_form_price_input_price', '_bx_courses_form_price_input_inf_price', 1, 0, 0, '', '', '', '', '', '', 'Float', '', 1, 0),
...
DELETE FROM `sys_form_display_inputs` WHERE `display_name` IN ('bx_courses_price_add', 'bx_courses_price_edit');
...
-- PRE-VALUES
DELETE FROM `sys_form_pre_lists` WHERE `key`='bx_courses_period_units';
INSERT INTO `sys_form_pre_lists`(`key`, `title`, `module`, `use_for_sets`) VALUES
('bx_courses_period_units', '_bx_courses_pre_lists_period_units', 'bx_courses', '0');

DELETE FROM `sys_form_pre_values` WHERE `Key`='bx_courses_period_units';
...
-- FAFORITES
UPDATE `sys_objects_favorite` SET `table_lists`='bx_courses_favorites_lists' WHERE `name`='bx_courses';
