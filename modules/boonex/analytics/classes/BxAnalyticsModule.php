              ...
              switch ($sReportName) {
                  ...
                  case BX_ANALYTICS_CONTENT_SPEED:
                      ...
                      if ($sModuleName != BX_ANALYTICS_SYSTEM){
                          ...
                          $aValues['strings'][1] = $oModule->_aModule['title'] . ($sReportName == BX_ANALYTICS_CONTENT_TOTAL ? _t('_bx_analytics_txt_total_count') : _t('_bx_analytics_txt_count'));
                      }
                      else{
                          $sTableName = 'sys_accounts';
                          $aValues['strings'][1] = _t('_bx_analytics_txt_accounts') . ($sReportName == BX_ANALYTICS_CONTENT_TOTAL ? _t('_bx_analytics_txt_total_count') : _t('_bx_analytics_txt_count'));
                      }
