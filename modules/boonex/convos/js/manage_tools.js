...
function BxCnvManageTools(oOptions) {
	this._iSearchTimeoutId = false;
	this._sActionsUrl = oOptions.sActionUrl;
	this._sObjNameGrid = oOptions.sObjNameGrid;
	this._sObjName = oOptions.sObjName == undefined ? 'oBxCnvManageTools' : oOptions.sObjName;
...
BxCnvManageTools.prototype.onChangeFilter = function (oFilter) {
    var $this = this;
    console.log($this._sObjNameGrid+"vcb");
...
BxCnvManageTools.prototype.onClickSettings = function (sMenuObject, oButton) {
...
BxCnvManageTools.prototype.onClickDelete = function (iContentId) {
