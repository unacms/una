-- TABLES
ALTER TABLE `bx_photos_entries` MODIFY `status_admin` enum('active','hidden','pending') NOT NULL DEFAULT 'active';
...
-- COMMENTS
DELETE FROM `sys_objects_cmts` WHERE `Name`='bx_photos_notes';
