...
VALUES('modules', 'bx_quoteofday', '_bx_quoteofday_adm_stg_cpt_type', 'bx_quoteofday@modules/boonex/quoteofday/|std-icon.svg', IF(ISNULL(@iTypeOrder), 1, @iTypeOrder + 1));
...
VALUES('bx_quoteofday_internal', 'Sql', 'SELECT * FROM `bx_quoteofday_internal` WHERE 1 ', 'bx_quoteofday_internal', 'id', 'added', 'status', '', 20, NULL, 'start', '', 'text', '', 'auto', '', '', 2147483647, 'BxQuoteofdayGridInternal', 'modules/boonex/quoteofday/classes/BxQuoteofdayGridInternal.php');
...
('bx_quoteofday_internal', 'text', '_bx_quoteofday_grid_column_title_adm_text', '40%', 0, 35, '', 3),
...
('bx_quoteofday_internal', 'independent', 'add', '_bx_quoteofday_grid_action_title_adm_add', 'add', 0, 0, 1);

-- CRON

INSERT INTO sys_cron_jobs(`name`, `time`, class, `file`, service_call) VALUES('bx_quoteofday', '0 1 * * *', 'BxQuoteofdayModule', '', 'a:2:{s:6:"module";s:13:"bx_quoteofday";s:6:"method";s:9:"set_quote";}');

-- PAGE: add block to homepage
SET @iBlockOrder = (SELECT `order` FROM `sys_pages_blocks` WHERE `object` = 'sys_home' AND `cell_id` = 1 ORDER BY `order` DESC LIMIT 1);

INSERT INTO sys_pages_blocks(object, cell_id, module, title_system, title, designbox_id, visible_for_levels, hidden_on, type, content, deletable, copyable, active, `order`) VALUES('sys_home', 1, 'bx_quoteofday', '', '_bx_quoteofday_page_block_title', 11, 2147483647, '0', 'service', 'a:2:{s:6:"module";s:13:"bx_quoteofday";s:6:"method";s:9:"get_quote";}', 1, 0, 1, IFNULL(@iBlockOrder, 0) + 1);

-- PAGE: create entry


INSERT INTO sys_objects_page(object, uri, title_system, title, module, cover, cover_image, layout_id, visible_for_levels, visible_for_levels_editable, url, meta_description, meta_keywords, meta_robots, cache_lifetime, cache_editable, deletable, override_class_name, override_class_file) VALUES('bx_quoteofday_manage', 'quoteofday-manage', '_bx_quoteofday_page_title_manage', '_bx_quoteofday_page_title_manage', 'bx_quoteofday', 1, 0, 5, 2147483647, 1, 'page.php?i=quoteofday-manage', '', '', '', 0, 1, 0, '', '');

INSERT INTO sys_pages_blocks(object, cell_id, module, title_system, title, designbox_id, visible_for_levels, hidden_on, type, content, deletable, copyable, active, `order`) VALUES('bx_quoteofday_manage', 1, 'bx_quoteofday', '_bx_quoteofday_page_block_title_manage', '_bx_quoteofday_page_block_title_manage', 11, 2147483647, '0', 'service', 'a:2:{s:6:"module";s:13:"bx_quoteofday";s:6:"method";s:17:"get_quotes_manage";}', 0, 1, 1, 1);

-- MENU: dashboard manage tools
SET @iManageMenuOrder = (SELECT IFNULL(MAX(`order`), 0) FROM `sys_menu_items` WHERE `set_name`='sys_account_dashboard_manage_tools' LIMIT 1);
INSERT INTO sys_menu_items(set_name, module, name, title_system, title, link, onclick, target, icon, addon, submenu_object, submenu_popup, visible_for_levels, active, copyable, editable, `order`) VALUES('sys_account_dashboard_manage_tools', 'bx_quoteofday', 'quoteofday-manage', '_bx_quoteofday_menu_item_title_system_admt_manage', '_bx_quoteofday_menu_item_title_system_admt_manage', 'page.php?i=quoteofday-manage', '', '_self', '', 'a:2:{s:6:"module";s:13:"bx_quoteofday";s:6:"method";s:27:"get_menu_addon_manage_tools";}', '', 0, 2147483647, 1, 0, 1, 6);

-- ACL
INSERT INTO sys_acl_actions(Module, Name, AdditionalParamName, Title, `Desc`, Countable, DisabledForLevels) VALUES('bx_quoteofday', 'manage entries', NULL, '_bx_quoteofday_acl_action_manage_entries', '', 1, 3);
