...
CREATE TABLE bx_quoteofday_internal (
  ...
  text text NOT NULL,
  source1 tinyint(4) NOT NULL DEFAULT 0,
  is_active1 tinyint(4) DEFAULT 0,
  added int(11) DEFAULT NULL,
  status enum ('active', 'hidden') DEFAULT 'active',
  author1 varchar(255) DEFAULT NULL,
  status_admin enum ('active', 'hidden') DEFAULT 'active',
  PRIMARY KEY (id),
  FULLTEXT INDEX title_text (text)
)
;
...
(3, 'bx_quoteofday', '_bx_quoteofday', '_bx_quoteofday', 'bx_quoteofday@modules/boonex/quoteofday/|std-icon.svg');

SET @iPageId = LAST_INSERT_ID();

INSERT INTO sys_std_widgets(page_id, module, url, click, icon, caption, cnt_notices, cnt_actions, bookmark) 
VALUES(@iPageId, 'bx_quoteofday', '{url_studio}module.php?name=bx_quoteofday', '', 'bx_quoteofday@modules/boonex/quoteofday/|std-icon.svg', '_bx_quoteofday', '', 'a:4:{s:6:"module";s:6:"system";s:6:"method";s:11:"get_actions";s:6:"params";a:0:{}s:5:"class";s:18:"TemplStudioModules";}', 0);
