...
-- GRIDS
DELETE FROM `sys_objects_grid` WHERE `object` IN ('bx_ribbons_data');
DELETE FROM `sys_grid_fields` WHERE `object` IN ('bx_ribbons_data');
DELETE FROM `sys_grid_actions` WHERE `object` IN ('bx_ribbons_data');
