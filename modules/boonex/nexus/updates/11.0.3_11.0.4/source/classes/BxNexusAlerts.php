...
class BxNexusAlerts extends BxDolAlertsResponse
{
    ...
    {
        if (getParam('bx_nexus_option_custom_homepage') && 'system' == $o->sUnit && 'page_output' == $o->sAction && 'sys_home' == $o->aExtras['page_name'] && !isLogged() && false !== strpos($_SERVER['HTTP_USER_AGENT'], 'UNAMobileApp')) {
