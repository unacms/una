...
function BxDirPolls(oOptions) {
    this._sActionsUri = oOptions.sActionUri;
    this._sActionsUrl = oOptions.sActionUrl;
    this._sObjName = oOptions.sObjName == undefined ? 'oBxDirPolls' : oOptions.sObjName;
...
BxDirPolls.prototype.initFlickity = function(oParent) {
    if(!oParent)
        return;
...
BxDirPolls.prototype.initPollForm = function(sFormId)
{
    var $this = this;
    var oForm = $('#' + sFormId);
...
BxDirPolls.prototype.beforePollFormSubmit = function(oForm)
{
    this.loadingInButton($(oForm).children().find(':submit'), true);
};

BxDirPolls.prototype.afterPollFormSubmit = function (oForm, oData)
{
    var $this = this;
...
BxDirPolls.prototype.deletePoll = function(oLink, iId)
{
    var $this = this;
...
BxDirPolls.prototype.showPollForm = function(oLink)
{
    var oData = this._getDefaultData();    
...
BxDirPolls.prototype.changePollView = function(oLink, sView, iPollId, onComplete) {
    var $this = this;
...
BxDirPolls.prototype.addPollAnswer = function(oButton, sName) {
    var oButton = $(oButton);
...
BxDirPolls.prototype.deletePollAnswer = function(oButton) {
    $(oButton).parents('.bx-form-input-answer:first').remove();
};

BxDirPolls.prototype.onPollAnswerVote = function(oLink, oData, iPollId) {
    var $this = this;
...
BxDirPolls.prototype.loadingInButton = function(e, bShow) {
    if($(e).length)
...
BxDirPolls.prototype.loadingInBox = function(e, bShow) {
    var oParent = $(e).length ? $(e).parents('.bx-base-text-poll:first') : $('body'); 
    bx_loading(oParent, bShow);
};

BxDirPolls.prototype.loadingInBlock = function(e, bShow) {
    var oParent = $(e).length ? $(e).parents('.bx-db-container:first') : $('body'); 
    bx_loading(oParent, bShow);
};

BxDirPolls.prototype._getDefaultData = function() {
    var oDate = new Date();
