...
function BxDirManageTools(oOptions) {
    this._iSearchTimeoutId = false;
    this._sActionsUrl = oOptions.sActionUrl;
    this._sObjNameGrid = oOptions.sObjNameGrid;
    this._sObjName = oOptions.sObjName == undefined ? 'oBxDirManageTools' : oOptions.sObjName;
...
BxDirManageTools.prototype.onChangeFilter = function(oFilter) {
    var $this = this;
...
BxDirManageTools.prototype.onClickSettings = function(sMenuObject, oButton) {
...
BxDirManageTools.prototype.onClickDelete = function(iContentId) {
