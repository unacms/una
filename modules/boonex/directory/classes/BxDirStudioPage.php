...
class BxDirStudioPage extends BxTemplStudioModule
{
    protected $_sModule;
    protected $_oModule;
    ...
    function __construct($sModule = "", $sPage = "")
    {
        ...
        $this->aMenuItems[] = array('name' => BX_DOL_STUDIO_MOD_TYPE_CATEGORIES, 'icon' => 'bars', 'title' => '_bx_directory_menu_item_title_categories');
    }
