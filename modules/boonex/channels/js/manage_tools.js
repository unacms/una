...
BxCnlManageTools.prototype.onChangeFilter = function (oFilter) {
	var $this = this;
...
BxCnlManageTools.prototype.onClickSettings = function (sMenuObject, oButton) {
...
BxCnlManageTools.prototype.onClickDelete = function (iContentId) {
	$('.bx-popup-applied:visible').dolPopupHide();

	glGrids[this._sObjNameGrid].actionWithId(iContentId, 'delete', {}, '', false, 1);
};

BxCnlManageTools.prototype.onClickDeleteWithContent = function (iContentId) {
	$('.bx-popup-applied:visible').dolPopupHide();
