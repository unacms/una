-- TABLES
ALTER TABLE `bx_snipcart_entries` CHANGE `allow_view_to` `allow_view_to` VARCHAR(16) NOT NULL DEFAULT '3';
...
-- VOTES
DELETE FROM `sys_objects_vote` WHERE `Name`='bx_snipcart_reactions';
