...
CREATE TABLE `bx_notes_meta_keywords` (
...
('bx_notes_files', 'Local', '', 360, 2592000, 3, 'bx_notes_files', 'allow-deny', 'jpg,jpeg,jpe,gif,png', '', 0, 0, 0, 0, 0, 0),
('bx_notes_photos_resized', 'Local', '', 360, 2592000, 3, 'bx_notes_photos_resized', 'allow-deny', 'jpg,jpeg,jpe,gif,png', '', 0, 0, 0, 0, 0, 0);
