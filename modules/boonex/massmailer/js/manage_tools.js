...
function BxMassMailerManageTools(oOptions) {
	this._iSearchTimeoutId = false;
	this._sActionsUrl = oOptions.sActionUrl;
	this._sObjNameGrid = oOptions.sObjNameGrid;
	this._sObjName = oOptions.sObjName == undefined ? 'oBxMassMailerManageTools' : oOptions.sObjName;
...
BxMassMailerManageTools.prototype.onChangeFilter = function (oFilter) {
	var $this = this;
...
BxMassMailerManageTools.prototype.onClickSettings = function (sMenuObject, oButton) {
...
BxMassMailerManageTools.prototype.onClickDelete = function (iContentId) {
