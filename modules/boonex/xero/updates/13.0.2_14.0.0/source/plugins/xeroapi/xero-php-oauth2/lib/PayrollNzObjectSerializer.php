...
use XeroAPI\XeroPHP\Models\PayrollNz\ModelInterface;
 ...
 * @link     https://openapi-generator.tech
 */
class PayrollNzObjectSerializer
{
    /**
     * Validate if date
     *
        ...
        if (is_scalar($data) || null === $data) {
            ...
            if ($data instanceof ModelInterface) {
                ...
                foreach ($data::openAPITypes() as $property => $openAPIType) {
                    ...
                    $value = $data->$getter();
                    if ($value !== null
                        && !in_array($openAPIType, ['\DateTime', '\SplFileObject', 'array', 'bool', 'boolean', 'byte', 'double', 'float', 'int', 'integer', 'mixed', 'number', 'object', 'string', 'void'], true)
