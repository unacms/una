...
/**
 * GetPaymentsResponse Class Doc Comment
 *
 * @category Class
 * @package  XeroAPI\XeroPHP
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class GetPaymentsResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetPaymentsResponse';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['payments']) && (count($this->container['payments']) < 1)) {
    ...
    public function setPayments($payments)
    {
        ...
        if (!is_null($payments) && (count($payments) < 1)) {
            throw new \InvalidArgumentException('invalid length for $payments when calling GetPaymentsResponse., number of items must be greater than or equal to 1.');
        }
