...
class AssetApi
{
     ...
     * @param  string $xero_tenant_id Xero identifier for Tenant (required)
     * @param  \XeroAPI\XeroPHP\Models\Asset\AssetType $asset_type Asset type to add (required)
     * @param  string $idempotency_key This allows you to safely retry requests without the risk of duplicate processing. 128 character max. (optional)
     * @throws \XeroAPI\XeroPHP\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \XeroAPI\XeroPHP\Models\Asset\AssetType
     */
    public function createAssetType($xero_tenant_id, $asset_type, $idempotency_key = null)
    {
        list($response) = $this->createAssetTypeWithHttpInfo($xero_tenant_id, $asset_type, $idempotency_key);
        return $response;
    }
    /**
     ...
     */
    public function createAssetTypeWithHttpInfo($xero_tenant_id, $asset_type, $idempotency_key = null)
    {
        $request = $this->createAssetTypeRequest($xero_tenant_id, $asset_type, $idempotency_key);
        try {
            $options = $this->createHttpClientOption();
            try {
                $response = $this->client->send($request, $options);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAssetTypeAsync($xero_tenant_id, $asset_type, $idempotency_key = null)
    {
        return $this->createAssetTypeAsyncWithHttpInfo($xero_tenant_id, $asset_type, $idempotency_key)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface */
    public function createAssetTypeAsyncWithHttpInfo($xero_tenant_id, $asset_type, $idempotency_key = null)
    {
        $returnType = '\XeroAPI\XeroPHP\Models\Asset\AssetType';
        $request = $this->createAssetTypeRequest($xero_tenant_id, $asset_type, $idempotency_key);
        return $this->client
     ...
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request  */
    protected function createAssetTypeRequest($xero_tenant_id, $asset_type, $idempotency_key = null)
    {
        // verify the required parameter 'xero_tenant_id' is set
        if ($xero_tenant_id === null || (is_array($xero_tenant_id) && count($xero_tenant_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($asset_type === null || (is_array($asset_type) && count($asset_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $asset_type when calling createAssetType'
            );
        }
