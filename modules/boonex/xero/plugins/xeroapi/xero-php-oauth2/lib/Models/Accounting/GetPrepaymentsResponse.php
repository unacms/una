...
/**
 * GetPrepaymentsResponse Class Doc Comment
 *
 * @category Class
 * @package  XeroAPI\XeroPHP
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class GetPrepaymentsResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetPrepaymentsResponse';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['prepayments']) && (count($this->container['prepayments']) < 1)) {
            $invalidProperties[] = "invalid value for 'prepayments', number of items must be greater than or equal to 1.";
        }
    ...
    public function setPrepayments($prepayments)
    {
        ...
        if (!is_null($prepayments) && (count($prepayments) < 1)) {
            throw new \InvalidArgumentException('invalid length for $prepayments when calling GetPrepaymentsResponse., number of items must be greater than or equal to 1.');
        }
