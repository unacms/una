 ...
 * @link     https://openapi-generator.tech
 */
class Journals implements ModelInterface, ArrayAccess, \Countable, \IteratorAggregate, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Journals';
    ...
    {
        if (is_null($offset)) {
            $this->container['journals'][] = $value;
        } else {
            $this->container['journals'][$offset] = $value;
        }
    }
