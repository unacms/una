 ...
 * @link     https://openapi-generator.tech
 */
class TrackingOptions implements ModelInterface, ArrayAccess, \Countable, \IteratorAggregate, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TrackingOptions';
    ...
    {
        return isset($this->container['options'][$offset]) ? $this->container['options'][$offset] : null;
    }
