 ...
 * @link     https://openapi-generator.tech
 */
class BankTransfers implements ModelInterface, ArrayAccess, \Countable, \IteratorAggregate, \JsonSerializable
{
    ...
    {
        return isset($this->container['bank_transfers'][$offset]);
    }
    ...
    {
        return isset($this->container['bank_transfers'][$offset]) ? $this->container['bank_transfers'][$offset] : null;
    }
    ...
    {
        if (is_null($offset)) {
            $this->container['bank_transfers'][] = $value;
        } else {
            $this->container['bank_transfers'][$offset] = $value;
        }
    }
