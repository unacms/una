 ...
 * @link     https://openapi-generator.tech
 */
class Accounts implements ModelInterface, ArrayAccess, \Countable, \IteratorAggregate, \JsonSerializable
{
    ...
    {
        return isset($this->container['accounts'][$offset]);
    }
    ...
    {
        return isset($this->container['accounts'][$offset]) ? $this->container['accounts'][$offset] : null;
    }
    ...
    {
        if (is_null($offset)) {
            $this->container['accounts'][] = $value;
        } else {
            $this->container['accounts'][$offset] = $value;
        }
    }
