...
class BalanceDetails implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BalanceDetails';
     ...
     * Sets currency_code
     *
     * @param string|null $currency_code The currency of the balance (Not required for base currency)
     *
     * @return $this
     */
     ...
     * Sets currency_rate
     *
     * @param double|null $currency_rate (Optional) Exchange rate to base currency when money is spent or received. If not specified, XE rate for the day is applied
     *
     * @return $this
     */
