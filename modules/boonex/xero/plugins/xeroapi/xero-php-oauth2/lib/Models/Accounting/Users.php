 ...
 * @link     https://openapi-generator.tech
 */
class Users implements ModelInterface, ArrayAccess, \Countable, \IteratorAggregate, \JsonSerializable
{
    ...
    {
        return isset($this->container['users'][$offset]);
    }
    ...
    {
        return isset($this->container['users'][$offset]) ? $this->container['users'][$offset] : null;
    }
    ...
    {
        if (is_null($offset)) {
            $this->container['users'][] = $value;
        } else {
            $this->container['users'][$offset] = $value;
        }
    }
