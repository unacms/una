 ...
 * @link     https://openapi-generator.tech
 */
class Reports implements ModelInterface, ArrayAccess, \Countable, \IteratorAggregate, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Reports';
    ...
    {
        return isset($this->container['reports'][$offset]);
    }
    ...
    {
        return isset($this->container['reports'][$offset]) ? $this->container['reports'][$offset] : null;
    }
    ...
    {
        if (is_null($offset)) {
            $this->container['reports'][] = $value;
        } else {
            $this->container['reports'][$offset] = $value;
        }
    }
