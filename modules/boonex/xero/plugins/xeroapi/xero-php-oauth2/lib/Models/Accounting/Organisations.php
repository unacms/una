 ...
 * @link     https://openapi-generator.tech
 */
class Organisations implements ModelInterface, ArrayAccess, \Countable, \IteratorAggregate, \JsonSerializable
{
    ...
    {
        if (is_null($offset)) {
            $this->container['organisations'][] = $value;
        } else {
            $this->container['organisations'][$offset] = $value;
        }
    }
