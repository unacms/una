 ...
 * @link     https://openapi-generator.tech
 */
class Budgets implements ModelInterface, ArrayAccess, \Countable, \IteratorAggregate, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'budgets' => '\XeroAPI\XeroPHP\Models\Accounting\Budget[]'
    ];
     ...
     * Gets budgets
     *
     * @return \XeroAPI\XeroPHP\Models\Accounting\Budget[]|null
     */
     ...
     * Sets budgets
     *
     * @param \XeroAPI\XeroPHP\Models\Accounting\Budget[]|null $budgets budgets
     *
     * @return $this
     */
    ...
    {
        if (is_null($offset)) {
            $this->container['budgets'][] = $value;
        } else {
            $this->container['budgets'][$offset] = $value;
        }
    }
