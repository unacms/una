 ...
 * @link     https://openapi-generator.tech
 */
class TrackingCategories implements ModelInterface, ArrayAccess, \Countable, \IteratorAggregate, \JsonSerializable
{
    ...
    {
        if (is_null($offset)) {
            $this->container['tracking_categories'][] = $value;
        } else {
            $this->container['tracking_categories'][$offset] = $value;
        }
    }
