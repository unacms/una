 ...
 * @link     https://openapi-generator.tech
 */
class ContactGroups implements ModelInterface, ArrayAccess, \Countable, \IteratorAggregate, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactGroups';
    ...
    {
        return isset($this->container['contact_groups'][$offset]);
    }
    ...
    {
        return isset($this->container['contact_groups'][$offset]) ? $this->container['contact_groups'][$offset] : null;
    }
    ...
    {
        if (is_null($offset)) {
            $this->container['contact_groups'][] = $value;
        } else {
            $this->container['contact_groups'][$offset] = $value;
        }
    }
