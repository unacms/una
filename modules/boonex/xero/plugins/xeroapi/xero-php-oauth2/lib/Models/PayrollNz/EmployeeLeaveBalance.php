...
/**
 * EmployeeLeaveBalance Class Doc Comment
 *
 * @category Class
 * @package  XeroAPI\XeroPHP
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class EmployeeLeaveBalance implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmployeeLeaveBalance';
     ...
     * Sets name
     *
     * @param string|null $name Name of the leave type.
     *
     * @return $this
     */
     ...
     * Sets balance
     *
     * @param double|null $balance The employees current balance for the corresponding leave type.
     *
     * @return $this
     */
     ...
     * Sets type_of_units
     *
     * @param string|null $type_of_units The type of the units of the leave.
     *
     * @return $this
     */
