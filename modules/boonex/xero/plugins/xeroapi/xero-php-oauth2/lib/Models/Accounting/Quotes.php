 ...
 * @link     https://openapi-generator.tech
 */
class Quotes implements ModelInterface, ArrayAccess, \Countable, \IteratorAggregate, \JsonSerializable
{
    ...
    {
        return isset($this->container['quotes'][$offset]);
    }
    ...
    {
        return isset($this->container['quotes'][$offset]) ? $this->container['quotes'][$offset] : null;
    }
    ...
    {
        if (is_null($offset)) {
            $this->container['quotes'][] = $value;
        } else {
            $this->container['quotes'][$offset] = $value;
        }
    }
