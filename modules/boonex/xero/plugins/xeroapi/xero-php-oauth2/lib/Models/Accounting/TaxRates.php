 ...
 * @link     https://openapi-generator.tech
 */
class TaxRates implements ModelInterface, ArrayAccess, \Countable, \IteratorAggregate, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TaxRates';
    ...
    {
        if (is_null($offset)) {
            $this->container['tax_rates'][] = $value;
        } else {
            $this->container['tax_rates'][$offset] = $value;
        }
    }
