 ...
 * @link     https://openapi-generator.tech
 */
class Attachments implements ModelInterface, ArrayAccess, \Countable, \IteratorAggregate, \JsonSerializable
{
     ...
     * Sets attachments
     *
     * @param \XeroAPI\XeroPHP\Models\Accounting\Attachment[]|null $attachments attachments
     *
     * @return $this
     */
    ...
    {
        return isset($this->container['attachments'][$offset]);
    }
    ...
    {
        return isset($this->container['attachments'][$offset]) ? $this->container['attachments'][$offset] : null;
    }
    ...
    {
        if (is_null($offset)) {
            $this->container['attachments'][] = $value;
        } else {
            $this->container['attachments'][$offset] = $value;
        }
    }
