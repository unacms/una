-- TABLES
ALTER TABLE `bx_shopify_entries` MODIFY `status_admin` enum('active','hidden','pending') NOT NULL DEFAULT 'active';
...
-- COMMENTS
DELETE FROM `sys_objects_cmts` WHERE `Name`='bx_shopify_notes';
