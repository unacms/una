...
function BxPersonsAdministration(oOptions) {
	this._sActionsUrl = oOptions.sActionUrl;
	this._sObjNameGrid = oOptions.sObjNameGrid;
    this._sObjName = oOptions.sObjName == undefined ? 'oBxPersonsAdministration' : oOptions.sObjName;
...
BxPersonsAdministration.prototype.onChangeFilter = function(oFilter) {
