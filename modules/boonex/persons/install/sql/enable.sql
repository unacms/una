...
('bx_persons_view', 'bx_persons', 'profile-connect-remove', '_bx_persons_menu_item_title_system_connect', '_bx_persons_menu_item_title_connect', 'javascript:void(0)', 'bx_conn_action(\'sys_profiles_connections\', \'remove\', \'{profile_id}\', true)', '', 'frown', '', 2147483647, 1, 0, 1),
...
('bx_persons_view', 'bx_persons', 'profile-subscribe-remove', '_bx_persons_menu_item_title_system_subscribe', '_bx_persons_menu_item_title_subscribe', 'javascript:void(0)', 'bx_conn_action(\'sys_profiles_subscriptions\', \'remove\', \'{profile_id}\')', '', 'minus-sign-alt', '', 2147483647, 1, 0, 3),
