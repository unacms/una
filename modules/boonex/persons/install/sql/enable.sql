...
INSERT INTO `sys_menu_items`(`set_name`, `module`, `name`, `title_system`, `title`, `link`, `onclick`, `target`, `icon`, `submenu_object`, `visible_for_levels`, `active`, `copyable`, `order`) VALUES 
('bx_persons_view', 'bx_persons', 'profile-friend-add', '_bx_persons_menu_item_title_system_befriend', '_bx_persons_menu_item_title_befriend', 'javascript:void(0)', 'bx_conn_action(\'sys_profiles_friends\', \'add\', \'{profile_id}\')', '', 'smile', '', 2147483647, 1, 0, 0),
('bx_persons_view', 'bx_persons', 'profile-friend-remove', '_bx_persons_menu_item_title_system_unfriend', '_bx_persons_menu_item_title_unfriend', 'javascript:void(0)', 'bx_conn_action(\'sys_profiles_friends\', \'remove\', \'{profile_id}\', true)', '', 'frown', '', 2147483647, 1, 0, 1),
