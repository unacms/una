...
class BxTemplConfig extends BxBaseConfig
{
    ...
    function __construct()
    {
        ...
        $this->_aConfig['aLessConfig']['bx-shadow-menu-add'] = $this->_setShadow($sName . '_menu_add_shadow');
        ...
        $this->_aConfig['aLessConfig']['bx-shadow-font-menu-add'] = $this->_setShadowFont($sName . '_menu_add_font_shadow');
        ...
        $this->_aConfig['aLessConfig']['bx-content-padding-menu-add'] = $this->_setMargin($sName . '_menu_add_content_padding');
        ...
        $this->_aConfig['aLessConfig']['bx-color-border-menu-add'] = $this->_setColorRgba($sName . '_menu_add_border_color', $sDefColBorder);
        ...
        $this->_aConfig['aLessConfig']['bx-border-width-menu-add'] = $this->_setSize($sName . '_menu_add_border_size');
        ...
        $this->_aConfig['aLessConfig']['bx-border-radius-form-input'] = $this->_setSize($sName . '_form_input_border_radius', '3px');
        ...
        $this->_aConfig['aLessConfig']['bx-font-family-menu-add'] = $this->_setValue($sName . '_menu_add_font_family');
        ...
        $this->_aConfig['aLessConfig']['bx-font-size-menu-add'] = $this->_setSize($sName . '_menu_add_font_size', '1.125rem');
        ...
        $this->_aConfig['aLessConfig']['bx-font-color-menu-add'] = $this->_setColorRgba($sName . '_menu_add_font_color', 'rgba(62, 134, 133, 1)');
        $this->_aConfig['aLessConfig']['bx-font-color-menu-add-hover'] = $this->_setColorRgba($sName . '_menu_add_font_color_hover', 'rgba(62, 134, 133, 1)');
        $this->_aConfig['aLessConfig']['bx-font-color-menu-add-active'] = $this->_setColorRgba($sName . '_menu_add_font_color_active', 'rgba(0, 0, 0, 1)');
        ...
        $this->_aConfig['aLessConfig']['bx-font-weight-menu-add'] = $this->_setValue($sName . '_menu_add_font_weight', '400');
        ...
        if($this->_isModule) {
            $this->setPageWidth('bx_lucid_page_width');

            $oModule = BxDolModule::getInstance($sName);
            if($oModule)
