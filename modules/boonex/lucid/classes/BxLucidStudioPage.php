...
define('BX_LUCID_STUDIO_TEMPL_TYPE_STYLES', 'styles');

class BxLucidStudioPage extends BxTemplStudioDesign
{
    function __construct($sModule = "", $sPage = "")
    {
        ...
        $this->aMenuItems[BX_LUCID_STUDIO_TEMPL_TYPE_STYLES] = array('caption' => '_bx_lucid_lmi_cpt_styles', 'icon' => 'paint-brush');
        unset($this->aMenuItems[BX_DOL_STUDIO_TEMPL_TYPE_LOGO]);
    }

    protected function getSettings($mixedCategory = '', $sMix = '')
    {
    	return parent::getSettings('bx_lucid_system', $sMix);
    }
