...
('bx_lucid_button_nlp_bg_color_hover', @iMixId, 'rgba(64, 169, 255, 1)'),
('bx_lucid_button_nlp_bg_color', @iMixId, 'rgba(24, 144, 255, 1)'),
('bx_lucid_button_nlp_height', @iMixId, '2rem'),
('bx_lucid_button_nl_font_weight', @iMixId, '600'),
('bx_lucid_button_nl_font_color', @iMixId, 'rgba(89, 89, 89, 1)'),
('bx_lucid_button_nl_font_family', @iMixId, '''Source Sans Pro'', -apple-system, BlinkMacSystemFont, ''Segoe UI'', Roboto, Helvetica, Arial, sans-serif'),
('bx_lucid_button_nl_font_size', @iMixId, '0.875rem'),
('bx_lucid_button_nl_font_shadow', @iMixId, 'none'),
('bx_lucid_button_nl_font_color_hover', @iMixId, 'rgba(64, 169, 255, 1)'),
('bx_lucid_button_nl_shadow', @iMixId, '0px 1px 3px 0px rgba(0, 0, 0, 0.05)'),
('bx_lucid_button_nl_border_size', @iMixId, '1px'),
('bx_lucid_button_nl_border_radius', @iMixId, '4px'),
('bx_lucid_button_nl_border_color', @iMixId, 'rgba(217, 217, 217, 1)'),
('bx_lucid_button_nl_border_color_hover', @iMixId, 'rgba(64, 169, 255, 1)'),
...
('bx_lucid_button_nl_bg_color_hover', @iMixId, 'rgba(255, 255, 255, 1)'),
...
('bx_lucid_button_lgp_font_family', @iMixId, '''Source Sans Pro'', -apple-system, BlinkMacSystemFont, ''Segoe UI'', Roboto, Helvetica, Arial, sans-serif'),
('bx_lucid_button_lgp_border_color_hover', @iMixId, 'rgba(0, 0, 0, 0.1)'),
('bx_lucid_button_lgp_height', @iMixId, '3rem'),
('bx_lucid_button_lgp_border_size', @iMixId, '0px'),
('bx_lucid_button_lgp_border_radius', @iMixId, '4px'),
('bx_lucid_button_lgp_bg_color', @iMixId, 'rgba(24, 144, 255, 1)'),
('bx_lucid_button_lgp_bg_color_hover', @iMixId, 'rgba(64, 169, 255, 1)'),
...
('bx_lucid_button_sm_border_radius', @iMixId, '2px'),
('bx_lucid_button_sm_font_family', @iMixId, '''Source Sans Pro'', -apple-system, BlinkMacSystemFont, ''Segoe UI'', Roboto, Helvetica, Arial, sans-serif'),
('bx_lucid_button_sm_font_color_hover', @iMixId, 'rgba(20, 80, 100, 1)'),
('bx_lucid_button_sm_border_color', @iMixId, 'rgba(217, 217, 217, 1)'),
('bx_lucid_button_sm_shadow', @iMixId, '0px 1px 3px 0px rgba(0, 0, 0, 0.05)'),
('bx_lucid_button_sm_border_color_hover', @iMixId, 'rgba(64, 169, 255, 1)'),
...
('bx_lucid_button_lg_font_family', @iMixId, '''Source Sans Pro'', -apple-system, BlinkMacSystemFont, ''Segoe UI'', Roboto, Helvetica, Arial, sans-serif'),
('bx_lucid_button_lg_font_size', @iMixId, '1rem'),
('bx_lucid_button_lg_font_color_hover', @iMixId, 'rgba(64, 169, 255, 1)'),
('bx_lucid_button_sm_bg_color_hover', @iMixId, 'rgba(255, 255, 255, 1)'),
('bx_lucid_button_lg_font_color', @iMixId, 'rgba(89, 89, 89, 1)'),
('bx_lucid_button_lg_border_size', @iMixId, '1px'),
('bx_lucid_button_lg_bg_color_hover', @iMixId, 'rgba(255, 255, 255, 1)'),
('bx_lucid_button_lg_border_radius', @iMixId, '4px'),
('bx_lucid_button_lg_shadow', @iMixId, '0px 1px 3px 0px rgba(0, 0, 0, 0.05)'),
('bx_lucid_button_lg_border_color_hover', @iMixId, 'rgba(64, 169, 255, 1)'),
('bx_lucid_button_lg_border_color', @iMixId, 'rgba(217, 217, 217, 1)'),
...
('bx_lucid_menu_account_font_size', @iMixId, '0.875rem'),
...
('bx_lucid_menu_main_font_size', @iMixId, '0.875rem'),
...
('bx_lucid_menu_main_content_padding', @iMixId, '0.5rem'),
...
('bx_lucid_button_smp_font_family', @iMixId, '''Source Sans Pro'', -apple-system, BlinkMacSystemFont, ''Segoe UI'', Roboto, Helvetica, Arial, sans-serif'),
...
('bx_lucid_button_smp_border_radius', @iMixId, '2px'),
('bx_lucid_button_smp_border_color_hover', @iMixId, 'rgba(64, 169, 255, 1)'),
('bx_lucid_button_smp_border_size', @iMixId, '1px'),
('bx_lucid_button_smp_border_color', @iMixId, 'rgba(217, 217, 217, 1)'),
('bx_lucid_button_smp_bg_color_hover', @iMixId, 'rgba(64, 169, 255, 1)'),
('bx_lucid_button_smp_height', @iMixId, '1.5rem'),
('bx_lucid_button_smp_bg_color', @iMixId, 'rgba(24, 144, 255, 1)'),
...
('bx_lucid_button_nlp_font_family', @iMixId, '''Source Sans Pro'', -apple-system, BlinkMacSystemFont, ''Segoe UI'', Roboto, Helvetica, Arial, sans-serif'),
('bx_lucid_button_nlp_border_radius', @iMixId, '4px'),
