...
('bx_files_entry_edit', 'do_submit', 2147483647, 1, 7),
...
('bx_files', 'bx_files', 'bx_files_reports', 'bx_files_reports_track', '1', 'page.php?i=view-file&id={object_id}', 'bx_files_main', 'id', 'author', 'reports', '', '');
