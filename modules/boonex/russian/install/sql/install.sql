...
(3, @sName, '', '', 'bx_ru@modules/boonex/russian/|std-pi.png');
SET @iPageId = LAST_INSERT_ID();

SET @iParentPageId = (SELECT `id` FROM `sys_std_pages` WHERE `name`='home');
SET @iParentPageOrder = (SELECT MAX(`order`) FROM `sys_std_pages_widgets` WHERE `page_id`=@iParentPageId);
INSERT INTO `sys_std_widgets`(`page_id`, `module`, `url`, `click`, `icon`, `caption`, `cnt_notices`, `cnt_actions`) VALUES
(@iPageId, @sName, CONCAT('{url_studio}language.php?name=', @sName), '', 'bx_ru@modules/boonex/russian/|std-wi.png', '_bx_rsn_wgt_cpt', '', 'a:4:{s:6:"module";s:6:"system";s:6:"method";s:11:"get_actions";s:6:"params";a:0:{}s:5:"class";s:20:"TemplStudioLanguages";}');
...
('languages', @sName, '_bx_rsn_stg_cpt_type', 'bx_ru@modules/boonex/russian/|std-mi.png', 2);
