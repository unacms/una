...
INSERT INTO `sys_form_display_inputs` (`display_name`, `input_name`, `visible_for_levels`, `active`, `order`) VALUES ('bx_posts_entry_add', 'location', 2147483647, 1, 6);

UPDATE `sys_form_display_inputs` SET `order`='5' WHERE `display_name`='bx_posts_entry_edit' AND `input_name`='allow_view_to' LIMIT 1;
INSERT INTO `sys_form_display_inputs` (`display_name`, `input_name`, `visible_for_levels`, `active`, `order`) VALUES ('bx_posts_entry_edit', 'location', 2147483647, 1, 6);
...
INSERT INTO `sys_objects_search` (`ObjectName`, `Title`, `ClassName`, `ClassPath`) VALUES ('bx_posts_cmts', '_bx_posts_cmts', 'BxPostsCmtsSearchResult', 'modules/boonex/posts/classes/BxPostsCmtsSearchResult.php');
