...
('bx_posts_cats', '1', 1, '_bx_posts_cat_General', ''),
('bx_posts_cats', '2', 2, '_bx_posts_cat_Special', ''),
('bx_posts_cats', '3', 3, '_bx_posts_cat_Bananas', ''),
('bx_posts_cats', '4', 4, '_bx_posts_cat_Uncategorized', '');
...
('bx_posts', 'bx_posts_cmts', 1, 5000, 1000, 1, 5, 3, 'tail', 1, 'bottom', 1, 1, 1, -3, 1, 'cmt', 'page.php?i=view-post&id={object_id}', '', 'bx_posts_posts', 'id', 'author', 'title', 'comments', '', '');
