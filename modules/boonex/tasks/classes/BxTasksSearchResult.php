...
class BxTasksSearchResult extends BxBaseModTextSearchResult
{
    function __construct($sMode = '', $aParams = array())
    {
        ...
        $this->aCurrent = array(
            'name' => 'bx_tasks',
            'module_name' => 'bx_tasks',
            'object_metatags' => 'bx_tasks',
            'title' => _t('_bx_tasks_page_title_browse'),
            'table' => 'bx_tasks_tasks',
        ...
        $this->sFilterName = 'bx_tasks_filter';
        ...
        switch ($sMode) {
            ...
            case 'public':
                ...
                $this->aCurrent['title'] = _t('_bx_tasks_page_title_browse_recent');
                $this->aCurrent['rss']['link'] = 'modules/?r=tasks/rss/' . $sMode;
                break;

            case 'featured':
                $this->sBrowseUrl = BxDolPermalinks::getInstance()->permalink($CNF['URL_HOME']);
                $this->aCurrent['title'] = _t('_bx_tasks_page_title_browse_featured');
            ...
            case 'popular':
                ...
                $this->aCurrent['title'] = _t('_bx_tasks_page_title_browse_popular');
                $this->aCurrent['rss']['link'] = 'modules/?r=tasks/rss/' . $sMode;
            ...
            case 'top':
                ...
                $this->aCurrent['title'] = _t('_bx_tasks_page_title_browse_top');
                $this->aCurrent['rss']['link'] = 'modules/?r=tasks/rss/' . $sMode;
            ...
            case 'updated':
                ...
                $this->aCurrent['title'] = _t('_bx_tasks_page_title_browse_updated');
                $this->aCurrent['rss']['link'] = 'modules/?r=tasks/rss/' . $sMode;
            ...
            case '': // search results
                ...
                $this->aCurrent['title'] = _t('_bx_tasks');
