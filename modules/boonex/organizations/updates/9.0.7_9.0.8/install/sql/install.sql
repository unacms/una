...
-- FORMS
DELETE FROM `sys_form_inputs` WHERE `object`='bx_organization' AND `name`='profile_ip';
...
DELETE FROM `sys_form_display_inputs` WHERE `display_name`='bx_organization_view' AND `input_name`='profile_ip';
