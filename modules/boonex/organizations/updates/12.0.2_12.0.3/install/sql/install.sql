...
-- FORMS
DELETE FROM `sys_objects_form` WHERE `object`='bx_organizations_price';
...
DELETE FROM `sys_form_displays` WHERE `object`='bx_organizations_price';
...
DELETE FROM `sys_form_inputs` WHERE `object`='bx_organizations_price';
...
('bx_organizations_price', 'bx_organizations', 'price', '', '', 0, 'text', '_bx_orgs_form_price_input_sys_price', '_bx_orgs_form_price_input_price', '_bx_orgs_form_price_input_inf_price', 1, 0, 0, '', '', '', '', '', '', 'Float', '', 1, 0),
...
DELETE FROM `sys_form_display_inputs` WHERE `display_name` IN ('bx_organizations_price_add', 'bx_organizations_price_edit');
...
-- PRE-VALUES
DELETE FROM `sys_form_pre_lists` WHERE `key`='bx_organizations_period_units';
INSERT INTO `sys_form_pre_lists`(`key`, `title`, `module`, `use_for_sets`) VALUES
('bx_organizations_period_units', '_bx_orgs_pre_lists_period_units', 'bx_organizations', '0');

DELETE FROM `sys_form_pre_values` WHERE `Key`='bx_organizations_period_units';
