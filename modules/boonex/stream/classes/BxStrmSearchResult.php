...
class BxStrmSearchResult extends BxBaseModTextSearchResult
{
    function __construct($sMode = '', $aParams = array())
    {
        ...
        $this->aCurrent = array(
            'name' => 'bx_stream',
            'module_name' => 'bx_stream',
            'object_metatags' => 'bx_stream',
            'title' => _t('_bx_stream_page_title_browse'),
            'table' => 'bx_stream_streams',
            ...
            'paginate' => array('perPage' => getParam('bx_stream_per_page_browse'), 'start' => 0),
            'sorting' => 'last',
            'rss' => array(
                'title' => '',
                'link' => '',
        ...
        $this->sFilterName = 'bx_stream_filter';
        ...
        switch ($sMode) {
            ...
            case 'public':
                ...
                $this->aCurrent['title'] = _t('_bx_stream_page_title_browse_recent');
                $this->aCurrent['rss']['link'] = 'modules/?r=stream/rss/' . $sMode;
                break;

            case 'featured':
                $this->sBrowseUrl = BxDolPermalinks::getInstance()->permalink($CNF['URL_HOME']);
                $this->aCurrent['title'] = _t('_bx_stream_page_title_browse_featured');
            ...
            case 'popular':
                ...
                $this->aCurrent['title'] = _t('_bx_stream_page_title_browse_popular');
                $this->aCurrent['rss']['link'] = 'modules/?r=stream/rss/' . $sMode;
            ...
            case 'top':
                ...
                $this->aCurrent['title'] = _t('_bx_stream_page_title_browse_top');
                $this->aCurrent['rss']['link'] = 'modules/?r=stream/rss/' . $sMode;
            ...
            case 'updated':
                ...
                $this->aCurrent['title'] = _t('_bx_stream_page_title_browse_updated');
                $this->aCurrent['rss']['link'] = 'modules/?r=stream/rss/' . $sMode;
            ...
            case '': // search results
                ...
                $this->aCurrent['title'] = _t('_bx_stream');
