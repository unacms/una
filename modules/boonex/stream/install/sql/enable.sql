...
('bx_stream_view_actions', 'bx_stream', 'social-sharing-facebook', '_sys_menu_item_title_system_social_sharing_facebook', '', '', '', '', '', '', '', 0, 2147483647, '', 1, 0, 300),
('bx_stream_view_actions', 'bx_stream', 'social-sharing-twitter', '_sys_menu_item_title_system_social_sharing_twitter', '', '', '', '', '', '', '', 0, 2147483647, '', 1, 0, 320),
('bx_stream_view_actions', 'bx_stream', 'social-sharing-pinterest', '_sys_menu_item_title_system_social_sharing_pinterest', '', '', '', '', '', '', '', 0, 2147483647, '', 1, 0, 330),
...
('bx_stream', 'bx_stream_meta_keywords', 'bx_stream_meta_locations', 'bx_stream_meta_mentions', '', '');
...
('bx_stream_cats', '', 'bx_stream', 'bx_stream_cats', 'bx_stream_streams', 'cat', 'INNER JOIN `sys_profiles` ON (`sys_profiles`.`id` = ABS(`bx_stream_streams`.`author`))', 'AND `sys_profiles`.`status` = ''active''', '', '');
...
('bx_stream_simple', 1, 'BxStrmUploaderSimple', 'modules/boonex/stream/classes/BxStrmUploaderSimple.php'),
...
('bx_stream_publishing', '* * * * *', 'BxStrmCronPublishing', 'modules/boonex/stream/classes/BxStrmCronPublishing.php', '');
