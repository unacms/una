...
DELETE FROM `sys_objects_actions` WHERE `Type` = '[db_prefix]' AND `Caption` = '_[db_prefix]_action_download' AND `Icon` = 'action_download.png';
...
UPDATE `sys_modules` SET `version` = '1.0.6' WHERE `uri` = 'files' AND `version` = '1.0.5';
