...
'discountQuantity', 'currencyCode', 'durationType', 'durationMonth', 'validTill', 'maxRedemptions','status', 'applyDiscountOn', 'applyOn', 'planConstraint', 'addonConstraint', 'createdAt', 'archivedAt','resourceVersion', 'updatedAt', 'includedInMrr', 'period', 'periodUnit', 'planIds', 'addonIds','itemConstraints', 'itemConstraintCriteria', 'redemptions', 'invoiceNotes', 'metaData');
