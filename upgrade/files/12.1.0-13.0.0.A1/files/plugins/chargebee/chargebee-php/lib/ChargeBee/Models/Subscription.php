...
'billingPeriodUnit', 'startDate', 'trialEnd', 'remainingBillingCycles', 'poNumber', 'autoCollection','planQuantityInDecimal', 'planUnitPriceInDecimal', 'customerId', 'planAmount', 'planFreeQuantity','status', 'trialStart', 'trialEndAction', 'currentTermStart', 'currentTermEnd', 'nextBillingAt','createdAt', 'startedAt', 'activatedAt', 'giftId', 'contractTermBillingCycleOnRenewal', 'overrideRelationship','pauseDate', 'resumeDate', 'cancelledAt', 'cancelReason', 'affiliateToken', 'createdFromIp','resourceVersion', 'updatedAt', 'hasScheduledAdvanceInvoices', 'hasScheduledChanges', 'paymentSourceId','planFreeQuantityInDecimal', 'planAmountInDecimal', 'cancelScheduleCreatedAt', 'offlinePaymentMethod', 'subscriptionItems', 'itemTiers', 'chargedItems', 'dueInvoicesCount', 'dueSince','totalDues', 'mrr', 'exchangeRate', 'baseCurrencyCode', 'addons', 'eventBasedAddons', 'chargedEventBasedAddons','coupon', 'coupons', 'shippingAddress', 'referralInfo', 'invoiceNotes', 'metaData', 'metadata','deleted', 'contractTerm', 'cancelReasonCode', 'freePeriod', 'freePeriodUnit', 'createPendingInvoices','autoCloseInvoices');
  ...
  {
    return ChargeBee_Request::send(ChargeBee_Request::GET, ChargeBee_Util::encodeURIPath("subscriptions",$id,"contract_terms"), $params, $env, $headers);
  }
