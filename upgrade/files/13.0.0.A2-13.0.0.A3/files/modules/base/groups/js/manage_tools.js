...
function BxBaseModGroupsManageTools(oOptions) {
    this._iSearchTimeoutId = false;
    this._sActionsUrl = oOptions.sActionUrl;
    this._sObjNameGrid = oOptions.sObjNameGrid;
    this._sObjName = oOptions.sObjName == undefined ? 'oBxBaseModGroupsManageTools' : oOptions.sObjName;
...
BxBaseModGroupsManageTools.prototype.onChangeFilter = function(oFilter) {
    var $this = this;
...
BxBaseModGroupsManageTools.prototype.onClickSettings = function(sMenuObject, oButton) {
...
BxBaseModGroupsManageTools.prototype.onClickDelete = function(iContentId) {
    $('.bx-popup-applied:visible').dolPopupHide();

    glGrids[this._sObjNameGrid].actionWithId(iContentId, 'delete', {}, '', false, 1);
};

BxBaseModGroupsManageTools.prototype.onClickDeleteWithContent = function(iContentId) {
    $('.bx-popup-applied:visible').dolPopupHide();

    glGrids[this._sObjNameGrid].actionWithId(iContentId, 'delete_with_content', {}, '', false, 1);
};

BxBaseModGroupsManageTools.prototype.onClickClearReports = function (iContentId) {
    $('.bx-popup-applied:visible').dolPopupHide();
